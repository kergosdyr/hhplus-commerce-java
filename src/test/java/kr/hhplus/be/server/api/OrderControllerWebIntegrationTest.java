...
class OrderControllerWebIntegrationTest extends WebIntegrationTest {
    ...
    @Test
    @DisplayName("POST /api/v1/orders 로 요청 시 Mocking된 성공 응답을 반환한다")
    void createOrder() throws Exception {
        ...
        mockMvc.perform(
            ...
            .andExpect(jsonPath("$.data.discountApplied").value(15000))
            ...
            .andExpect(jsonPath("$.data.orderItems[0].itemPrice").value(50000))
            .andExpect(jsonPath("$.data.orderItems[1].productId").value(2))
            .andExpect(jsonPath("$.data.orderItems[1].quantity").value(3))
            .andExpect(jsonPath("$.data.orderItems[1].itemPrice").value(20000))
